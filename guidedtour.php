            ...
            <div class="tourPageSlider">
                <section class="tourpage tourstart">
                    <article class="infobox">
                        ...
                        <p>This tour will take you through each of the five major natural disaster types most commonly
                            impacting the Australian continent. At the end of the tour you will have the chance to play
                            the Higher or Lower game.</p>
                        <p>For participating in the exhbit and learning about Australia's natural disasters, the Natural
                            Disaster Musuem will donate a dollar figure to the Climate Education Foundation based on the
                            score you get on the Higher or Lower game.</p>
                        <p>Good luck!</p>
                    </article>
                </section>
